...
assertAll(
        ...
        assertAll(
                ...
                ()->  assertTrue
                (organizedSubList.get(0).getTaskStartTime().isBefore(organizedSubList.get(1).getTaskStartTime())),
                ()->  assertTrue
                (organizedSubList.get(1).getTaskStartTime().isBefore(organizedSubList.get(2).getTaskStartTime())),
                ()->  assertTrue
                (organizedSubList.get(2).getTaskStartTime().isBefore(organizedSubList.get(3).getTaskStartTime()),
                "Элементы отсортированы по дате начала."),

                ()->   assertTrue
                (organizedSubList.get(0).getTaskEndTime().isBefore(organizedSubList.get(1).getTaskStartTime())),
                ()->   assertTrue
                (organizedSubList.get(1).getTaskEndTime().isBefore(organizedSubList.get(2).getTaskStartTime())),
                ()->   assertTrue
                (organizedSubList.get(2).getTaskEndTime().isBefore(organizedSubList.get(3).getTaskStartTime()),
